...
Ensure you have the latest version of [Node.js](https://nodejs.org/) installed, which includes npm (Node Package Manager).

### Installation

1. Clone the repository:
   ```bash
   git clone https://github.com/your-username/trivia-tidbits.git
   cd trivia-tidbits
